...
$cfg_softtype = 'gz|7z|zip|rar|iso|wps|txt|doc|docx|xls|xlsx|ppt|pptx|pdf';
$cfg_mediatype = 'swf|rm|rmvb|mpg|mp3|mp4|wmv|wma|wav|mid|mov';
$cfg_specnote = 10;
$cfg_notallowstr = '废物|垃圾|脑残|神经病|变态';
$cfg_replacestr = '废物|垃圾|脑残|神经病|变态';
$cfg_feedbackcheck = 'Y';
$cfg_keyword_replace = 'Y';
$cfg_df_style = 'dedex';
$cfg_multi_site = 'N';
$cfg_dede_log = 'N';
$cfg_powerby = 'Copyright © 2025 DedeX 版权所有';
$cfg_arcsptitle = 'N';
$cfg_arcautosp = 'N';
...
$cfg_smtp_server = 'ssl://smtp.qq.com';
$cfg_smtp_port = '465';
$cfg_smtp_usermail = '';
$cfg_smtp_user = '';
$cfg_smtp_password = '';
...
$cfg_keywords = 'DedeX';
$cfg_tags_dir = '/a/tags';
$cfg_description = 'DedeX系统基于PHP7开发，遵循GPLv2协议开源，具有简洁易用、灵活扩展、高安全性和高效性等特点。其模板设计继承了原有标签体系，并引入Bootstrap，简化了PC、平板及移动端站点的搭建过程。';
$cfg_beian = '';
$cfg_need_typeid2 = 'Y';
$cfg_cache_type = 'id';
$cfg_max_face = 2024;
