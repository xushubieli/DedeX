...
function MakeUpload(mnum) {
	...
	for (startNum;startNum < endNum;startNum++)
	{
		...
		fhtml += "<div id=\"seltb" + startNum + "\" class='mb-3' style=\"" + dplay + "\"><span>图片" + startNum + "上传：</span><div class='input-group mb-3'><input type='text' name='imgfile" + startNum + "' class='form-control' placeholder='请选择图片上传或填写图片地址'><button type='button' class='btn btn-primary btn-sm' onClick=\"SelectImage('addcontent.imgfile" + startNum + "', 'big')\">选择</button></div><span>图片" + startNum + "简介：</span><textarea name='imgmsg" + startNum + "' class='form-control'></textarea></div>";
