...
if ($dopost != 'save') {
    ...
    //返回成功信息
    $msg = "<tr>
        <td align='center'><a href='{$artUrl}' target='_blank' class='btn btn-primary btn-sm'>浏览专题</a><a href='spec_add.php?cid={$typeid}' class='btn btn-primary btn-sm'>发布专题</a><a href='archives_do.php?aid={$arcID}&dopost=editArchives' class='btn btn-primary btn-sm'>修改专题</a><a href='content_s_list.php' class='btn btn-primary btn-sm'>返回专题列表</a></td>
    </tr>";
    $wintitle = "成功发布专题";
    $win = new OxWindow();
    $win->AddMsgItem($msg);
