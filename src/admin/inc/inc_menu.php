...
if ($cuserLogin->getUserType() >= 10) {
    $adminMenu1 = (DEDEX_SAFE_MODE ? "" : "<m:top item='11_' name='模板管理' rank='temp_One,temp_Other,temp_MyTag,temp_test,temp_All' icon='bi bi-stack'>
...
<m:top item='4_' name='模型管理' rank='t_List,t_AccList,c_List,temp_One' icon='bi bi-database'>
    ".(DEDEX_SAFE_MODE ? "" : "<m:item name='文档模型管理' link='mychannel_main.php' rank='c_List' target='main' />")."
  ...
  $adminMenu2 = "<m:top item='10_' name='财务管理' rank='sys_Data' icon='bi bi-wallet2'>
...
$menusMain = "<m:top item='1_' name='常用功能' icon='bi bi-laptop'>
...
<m:top item='2_' name='文档管理' icon='bi bi-file-text'>
    $addset
</m:top>
<m:top item='3_' name='附件管理' rank='sys_Upload,sys_MyUpload,plus_文件管理器' icon='bi bi-folder2'>
...
$adminMenu1
<m:top item='5_' name='文档维护' icon='bi bi-sticky'>
    ...
    ".(DEDEX_SAFE_MODE ? "" : "<m:item name='数据库字段替换' link='sys_data_replace.php' rank='sys_ArcBatch' target='main' />")."
</m:top>
{$GLOBALS['menusMoudle']}
<m:top item='8_' name='更新网站' rank='sys_MakeHtml' icon='bi bi-arrow-counterclockwise'>
...
$adminMenu2
<m:top item='12_' name='关于我们' icon='bi bi-info-circle'>
